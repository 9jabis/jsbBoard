				...
				<table class="table table-striped"
					...
					<tbody>
						...
						<tr>
							...
							<td><a
								href="view.jsp?boardID=<%=list.get(i).getBoardID()%>&bbsID=<%= list.get(i).getBbsID() %>"><%= list.get(i).getBbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>") %></a></td>
